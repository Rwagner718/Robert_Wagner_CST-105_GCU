 ...
 *Week2 Assignments
 *
 *(TheTimeclass) Design a class named Time. The class contains: 
...
time since midnight, January 1, 1970, in milliseconds. (The values of the 
data fields will represent this time.)
■ A constructor that constructs a Time object with the specified 
